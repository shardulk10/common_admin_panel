...
class Home extends BaseController
{
    ...
    public function index(){
        ...
        if(isset($_POST['sbtService']) && !empty($_POST['sbtService']) && $_POST['sbtService'] == 'sbtService') {
          ...
          $accept_privacy_policy = !empty($_POST['accept_privacy_policy']) ? "Yes ".date("d/m/Y/") : "No";
    ...
    public function service($slug = NULL){
        ...
        if(!empty($slug)) {
            $pageInfo['service_content'] = $this->Staticpages_model->getStaticDetailsUsingSlug($slug);    
        } else {
    ...
    public function products($slug = NULL){
        ...
        if(!empty($slug)) {
            $pageInfo['products_full_content'] = $this->Staticpages_model->getStaticDetailsUsingSlug($slug);    
        } else {
    ...
    public function privacy_policy(){
        ...
        $pageInfo['privacy_policy_content'] = $this->Staticpages_model->getStaticDetailsUsingSlug('privacy_policy');
    ...
    public function demo_sample(){
        ...
        $this->load->view('frontend/frontend_header', $headerInfo);
        $this->load->view('frontend/testimonials1', $pageInfo);
        $this->load->view('frontend/frontend_footer', $footerInfo);
    }
