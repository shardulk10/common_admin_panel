<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Edit Banners
        <small>Add / Edit Banners</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Banners Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addSlide" action="<?php echo base_url() ?>updateBanners/<?php echo $slideInfo->id ?>" method="post" role="form" enctype='multipart/form-data' <?php if($this->session->userdata("role")== 3){ echo 'onSubmit="return false";';} ?>>
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php if(isset($slideInfo->banner_heading)) {echo ($slideInfo->banner_heading);}  ?>" id="banner_heading" name="banner_heading" maxlength="500">
                                    </div>
                                </div>
                              </div>
                               ...
                               <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        <label for="fname">Banner Image</label>
                                        <input type="file" class="form-control" value="" id="banner_image" name="banner_image">
                                        <?php if(!empty($slideInfo->banner_path)) { ?>
                                          <img src="<?php echo $slideInfo->banner_path ?>" width="120" height="120" />
                                        <?php } ?>
                                    </div>                                    
                                </div>
                              </div> 
                            ...
                            <div class="col-md-5">
                                    <div class="form-group">
                                       <div class="box-footer" style="margin-top: 12px;">
                                            ...
                                            <a class="btn btn-default" href="<?php echo base_url() ?>manageBanners">Back</a>
                                        </div>
                                    </div>
                                </div> 
                             </div>   
