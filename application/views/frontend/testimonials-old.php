          ...
          <div class="row">
             <div class="col-md-12">
                 <ol class="breadcrumb breadcrumb-finance">
                    ...
                    <li class="active">Happy Clients</li>
                  </ol>
             </div><!--  End col -->
          </div> <!-- End Row -->
       </div><!-- End container -->
              ...
              <div class="col-md-12">
                <div class="item item-testimonials-3-columns text-left">
                    ...
                    <div class="avatar-testimonials-3-columns">
                      <img height="75" width="75" src="<?php echo $row->image_path;?>" class="img-responsive" alt="Image">
                    </div>
                    <h4 class="name-testimonials-3-columns"><?php echo $row->name;?></h4><br/><br/>
