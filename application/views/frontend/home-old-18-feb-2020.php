                    ...
                    <div id="revolution-slider-home-3" class="slider-home-3">
                        <ul>  <!-- SLIDE  -->
                            <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                              <!-- MAIN IMAGE -->
                              <img src="<?php echo base_url(); ?>assets/frontend/images/Slider/21_1.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="center" data-bgrepeat="no-repeat">
                              
                              <!-- LAYER NR. 1 -->
                              <div class="tp-caption sfb h1-text text-blue text-center text-cap"
                                    data-x="55"
                                    data-y="250"
                                    data-speed="500"
                                    data-start="800"
                                    data-easing="easeInOutCubic"
                                    >Portfolio management<br> Services (PMS)
                                  </div> 
                            ...
                            <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                              <!-- MAIN IMAGE -->
                              <img src="<?php echo base_url(); ?>assets/frontend/images/Slider/22_1.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="center" data-bgrepeat="no-repeat">
                              
                              <!-- LAYER NR. 1 -->
                             <div class="tp-caption sfb h1-text text-blue text-cap"
                                data-x="55"
                                data-y="250"
                                data-speed="500"
                                data-start="800"
                            ...
                            <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                              <!-- MAIN IMAGE -->
                              <img src="<?php echo base_url(); ?>assets/frontend/images/Slider/23_1.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="center" data-bgrepeat="no-repeat">
                            ...
                            <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                              <!-- MAIN IMAGE -->
                              <img src="<?php echo base_url(); ?>assets/frontend/images/Slider/24_1.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="center" data-bgrepeat="no-repeat">
                            ...
                            <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                              <!-- MAIN IMAGE -->
                              <img src="<?php echo base_url(); ?>assets/frontend/images/Slider/25_1.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="center" data-bgrepeat="no-repeat">
                  ...
                  <div class="get-call-back-contain">
                    <div class="col-md-6 get-call-back-left">
                      <div class="call-back-text">
                        ...
                        <p class="text-grey">If you need to speak to us about an query fill in the form below and we will call you back.</p>
                      </div><!-- End call back text left -->
                    </div>
                    <div class="col-md-6 get-call-back-right">
                      <div class="call-back-form">
                        <form name="servicehomeform" method="post" >
                          <p>How can we help? *
                          ...
                          <button type="submit" name="sbtService" value="sbtService" class="ot-btn large-btn  btn-light btn-submit">Submit</button>
                        </form>
                        ...
                        <div class="three-column-text clearfix">
                          <div class="col-md-4">
                            <div class="make-easy-item">
                               <h4>Whatever</h4>
                               <p>Whatever your financial needs are -You need guidance or consultation, looking for long term or short term investments, insurances, loans, etc., we are here for you. Just give us a shout out and we will be glad to help you! </p>
                            </div>
                          </div><!-- end col -->
                          <div class="col-md-4">
                            <div class="make-easy-item">
