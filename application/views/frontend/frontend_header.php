...
<?php
  ...
  $CI->load->model('Staticpages_model');
  $menutype_content = $CI->Staticpages_model->getStaticPagesUsingMenuType('product_menu');
  
  $menutype_servicecontent = $CI->Staticpages_model->getStaticPagesUsingMenuType('maxima_services');
?>
<!-- SETTINGS DATA END -->
              ...
              <ul>
                  ...
                  <li>
                    ...
                    <ul class="navi-level-2 ">
                        <?php foreach($menutype_servicecontent AS $keyService=>$dataRowService) { ?>
                            <li><a href="<?php echo base_url(); ?>service/<?php echo $dataRowService->slug;?>"><?php echo $dataRowService->page_title;?></a></li>
                        <?php } ?>
                    </ul>
                </li>
                  ...
                  <li class="has-sub">
                    <a href="#">Products<i class="fa fa-angle-down"></i></a> 
                        <ul class="navi-level-2 ">
                            <?php foreach($menutype_content AS $key=>$dataRow) { ?>
                                <li><a href="<?php echo base_url(); ?>products/<?php echo $dataRow->slug;?>"><?php echo $dataRow->page_title;?></a></li>
                            <?php } ?>
                        </ul>
                </li>
      ...
      <div class="container">
        <div class="logo">
            <div class="mm-toggle visible-xs visible-sm">
              <i class="fa-remove fa fa-bars"></i><span class="mm-label"></span>
            </div>
            <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/frontend/images/Header/Maxima-Logo_1.png" class="img-responsive" alt="Image">
			
			</a>
            <div class="text-center blue slogan "> <span>
