<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Edit Gallery
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" id="addSlide" action="<?php echo base_url() ?>updateGallery/<?php echo $slideInfo->id ?>" method="post" role="form" enctype='multipart/form-data' <?php if($this->session->userdata("role")== 3){ echo 'onSubmit="return false";';} ?>>
                        <div class="box-body">
                            
                            <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        <label for="fname">Gallery Heading</label>
                                        <input type="text" class="form-control required" value="<?php if(isset($slideInfo->gallery_heading)) {echo ($slideInfo->gallery_heading);}  ?>" id="gallery_heading" name="gallery_heading" maxlength="500">
                                    </div>
                                </div>
                              </div>
                               ...
                               <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        <label for="fname">Gallery Image</label>
                                        <input type="file" class="form-control" value="" id="gallery_image" name="gallery_image">
                                        <?php if(!empty($slideInfo->gallery_path)) { ?>
                                          <img src="<?php echo $slideInfo->gallery_path ?>" width="120" height="120" />
                                        <?php } ?>
                                    </div>                                    
                                </div>
                              </div> 
                            ...
                            <div class="col-md-5">
                                    <div class="form-group">
                                       <div class="box-footer" style="margin-top: 12px;">
                                            ...
                                            <a class="btn btn-default" href="<?php echo base_url() ?>manageGallery">Back</a>
                                        </div>
                                    </div>
                                </div> 
                             </div>   
