    ...
    <header id="sticked-menu" class="header header-v5">
      <div class="container">
        ...
        <nav class="navi-desktop-site hidden-sm hidden-xs">
            ...
            <li class="has-sub"><a href="<?php echo base_url(); ?>testimonials" <?php echo (!empty($active_testimonials) ? 'class="active"' : '')?>>Testimonial</a></li>
            <li class="has-sub"><a href="<?php echo base_url(); ?>our_team" <?php echo (!empty($active_ourteam) ? 'class="active"' : '')?>>Our Team</a></li>
